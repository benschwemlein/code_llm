...
2. Local Use Only and Hosting Restriction
   Local RAG LLM is designed so that all processing remains on your machine.
   The software cannot be hosted, provided, or made accessible in any cloud service or remote environment.
   You are responsible for complying with all laws and agreements that apply to any source code or data you process with the software.
...
4. Ownership and Contribution Rights
   ...
   Submitting a feature request, bug report, suggestion, or other feedback does not grant the submitter any rights in the software or its design.
